...
echo -e "\t--Python 3.7.0 is installed"
...
if  [ "$data" == distances.py ]; then
    echo "Calculating distances...we are not rich please dont run it many times"
    $PYTHON distances.py
fi

if  [ "$data" == data_cleanup.py ]; then
